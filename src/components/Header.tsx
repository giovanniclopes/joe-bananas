  ...
  return (
    <header>
      <nav
        className={
          fix
            ? "z-50 fixed top-0 w-full h-16 flex items-center justify-between py-3 px-8 mx-auto bg-violet-300/70 bg-no-repeat bg-cover bg-fixed border-b border-yellow-500 transition-all md:items-center mbl:px-4"
